...
@EnableJpaRepositories(basePackages = "com.kpfu.javalab.todoApp.repository")
public class PersistenceContext {
    ...
    private static final String PROPERTY_PACKAGES_TO_SCAN = "com.kpfu.javalab.todoApp.entity";
